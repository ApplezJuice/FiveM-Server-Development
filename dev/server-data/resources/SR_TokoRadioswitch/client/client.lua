...
function OpenRadioMenu()
  ...
  local elements = {
    ...
    if (PlayerData.job.name == 'police' or PlayerData.job.name == 'fire' or PlayerData.job.name == 'state' or PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'policeambulance' ) then
      ...
      table.insert(elements, { label = _U('R1'), value = 'radio10'})  
      table.insert(elements, { label = _U('R2'), value = 'radio11'})  
      table.insert(elements, { label = _U('R3'), value = 'radio12'}) 
      table.insert(elements, { label = _U('R4'), value = 'radio13'})  
      table.insert(elements, { label = _U('R5'), value = 'radio14'})  
...
if channel == 13 then
      ...
      if data.current.value == 'radio10' then -- PD Radio
...
if channel == 20 then
		  ...
		  exports.tokovoip_script:addPlayerToRadio(10) -- PD Radio 
		channel = 10
      end
	 
      if data.current.value == 'radio11' then -- EMS Radio 
...
if channel == 20 then
		  ...
		  exports.tokovoip_script:addPlayerToRadio(11) -- EMS Radio 
		channel = 11
      end
	  
      if data.current.value == 'radio12' then -- PD/SO/EMS Radio 
...
if channel == 20 then
		  ...
		  exports.tokovoip_script:addPlayerToRadio(12) -- PD/SO/EMS Radio 
		channel = 12
      end  
	  
      if data.current.value == 'radio13' then -- SO Radio 
...
if channel == 20 then
		  ...
		  exports.tokovoip_script:addPlayerToRadio(13) -- SO Radio 
		channel = 13
      end 
	  
      if data.current.value == 'radio14' then -- PD/SO Radio 
...
if channel == 18 then
          exports.tokovoip_script:removePlayerFromRadio(18)
		  		  ...
		  		  exports.tokovoip_script:addPlayerToRadio(14) -- PD/SO Radio 
		channel = 14
      end 

      CurrentAction     = 'radio'
      CurrentActionMsg  = _U('Channel select')
      CurrentActionData = {}
