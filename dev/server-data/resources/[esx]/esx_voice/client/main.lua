...
Citizen.CreateThread(function()
	while true do
		...
		if NetworkIsPlayerTalking(PlayerId()) and voice.level == _U('normal') then
			drawLevel(41, 128, 185, 255)
		elseif NetworkIsPlayerTalking(PlayerId()) and voice.level == _U('shout') then
                        drawLevel(255, 0, 0, 255)
		elseif NetworkIsPlayerTalking(PlayerId()) and voice.level == _U('whisper') then
                        drawLevel(255, 255, 0, 255)
