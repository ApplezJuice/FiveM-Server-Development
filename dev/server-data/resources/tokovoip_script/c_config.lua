...
TokoVoipConfig = {
	...
	radioKey = Keys["U"], -- Keybind used to talk on the radio
	...
	plugin_data = {
		...
		TSChannel = "Server_1",
		TSPassword = "test", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "applezjuice.rocks", -- TeamSpeak server address to be displayed on blocking screen
		TSChannelSupport = "dev", -- TeamSpeak support channel name displayed on blocking screen
		TSDownload = "http://applezjuice.rocks", -- Download link displayed on blocking screen
